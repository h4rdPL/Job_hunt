...
export const JobTemplate = ({ jobCategory }) => {
  ...
  return (
    <Wrapper>
      <LogoWrapper>
        <LogoParagraph>find jobs from</LogoParagraph>
        ...
        jobOffers.slice(0, visibleJobCount).map((offer) => (
          <Test key={offer.id}>
            <JobfferWrapper>
              ...
              <CompanyWrapper>
                <Heading>{offer.job_name}</Heading>
                <Paragraph>
                  {offer.companyName}
              ...
              <Button
                ...
                style={{
                  ...
                  border:
                    openOfferId === offer.id ? "1px solid #4348DB" : "none",
                }}
              >
            ...
            <More
              style={{
                display: openOfferId === offer.id ? "block" : "none",
                height: openOfferId === offer.id ? "auto" : 0,
              }}
            >
              <OfferWrapper>
                <span>
                ...
                <span>
                  <InformationHeader>Responsabilities:</InformationHeader>
                  <ResponibilitiesList>
                ...
                <span>
                  <InformationHeader>Our ideal candidate:</InformationHeader>
                  <OfferParagraph>{offer.idealCandidate}</OfferParagraph>
                </span>
              </OfferWrapper>
              <OpinionWrapper>
                <ul>
